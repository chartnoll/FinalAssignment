...
//     const theStudentRe = students.filter( (student) => student.id ===
//         selectRandomStudent(evaluations.filter((evaluation) => {
//             evaluation.color == luckyColor
//             console.log(evaluation.color, student.id)
//         })))
//     console.log("line45", theStudentRe)
//     return theStudentRe
// }

export const evaluationCheck = (evaluation) => {
    if (evaluation.date === new Date().toISOString().slice(0, 10)) return true
    else return false
}
